...
| [SimpleWebP](https://github.com/MikuAuahDark/simplewebp) | [Miku AuahDark](https://github.com/MikuAuahDark) | [Decoder](https://en.wikipedia.org/wiki/Codec)/[container](https://en.wikipedia.org/wiki/Resource_Interchange_File_Format) for [YCbCr](https://en.wikipedia.org/wiki/YCbCr) still [DV](https://en.wikipedia.org/wiki/Digital_video) and [https://en.wikipedia.org/wiki/RGBA_color_modeldata](RGBA) data. |
