...
| --- | --- | --- | --- |
| [7-Zip](https://7-zip.org/sdk.html) | 24 | [Igor Pavlov](https://en.wikipedia.org/wiki/Igor_Pavlov_(programmer)) | Powerful general data [codec](https://en.wikipedia.org/wiki/Codec). |
...
| [GLFW](https://github.com/glfw/glfw) | 3.4 | [© Marcus Geelnard & Camilla Löwy](https://www.glfw.org/) | Interface to Window, [OpenGL](https://en.wikipedia.org/wiki/OpenGL) and [input](https://en.wikipedia.org/wiki/Input_device). |
...
| [MiniMP3](https://github.com/lieff/minimp3) ([modded](https://github.com/Mhatxotic/MiniMP3)) | 25.3.12 | Lieff/Lion | [Codec](https://en.wikipedia.org/wiki/Codec)/[Container](https://en.wikipedia.org/wiki/MP3) for legacy [PCM](https://en.wikipedia.org/wiki/Pulse-code_modulation) audio data. |
| [NCurses](https://linux.die.net/man/3/ncurses) | 6.5 | [© Free Software Foundation](https://en.wikipedia.org/wiki/Free_Software_Foundation) | [Linux](https://en.wikipedia.org/wiki/Linux) and [MacOS](https://en.wikipedia.org/wiki/MacOS) [text mode](https://en.wikipedia.org/wiki/Computer_terminal) support. |
...
| [OpenALSoft](https://github.com/kcat/openal-soft) | 1.24 | [Chris Robinson](https://www.openal-soft.org/) | [3-D audio API](https://en.wikipedia.org/wiki/OpenAL). |
| [OpenSSL](https://github.com/openssl/openssl) | 3.4 | [OpenSSL Software Foundation](https://www.openssl.org/) | Basic [SSL](https://en.wikipedia.org/wiki/Transport_Layer_Security) networking and (de/en)cryption. |
...
| [SQLite](https://github.com/sqlite/sqlite) | 3.47 | [Contributing authors](https://sqlite.org/) | [Interpreter](https://en.wikipedia.org/wiki/SQLite) to store and access user non-volatile data. |
