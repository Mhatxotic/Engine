...
| [MiniMP3](https://github.com/lieff/minimp3) | 21.11.30 | Lieff/Lion | [Codec](https://en.wikipedia.org/wiki/Codec)/[Container](https://en.wikipedia.org/wiki/MP3) for legacy [PCM](https://en.wikipedia.org/wiki/Pulse-code_modulation) audio data. |
