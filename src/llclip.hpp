...
/* ------------------------------------------------------------------------- */
LLFUNC(Destroy, 0, LuaUtilClassDestroy<Clip>(lS, cClips))
/* ========================================================================= */
// $ Clip:Destroyed
...
** ========================================================================= */
// $ Clip.Count
// < Count:integer=Total number of clips created.
// ? Returns the total number of clip classes currently active.
/* ------------------------------------------------------------------------- */
...
LLRSBEGIN                              // Clip.* namespace functions begin
  LLRSFUNC(Count), LLRSFUNC(Get), LLRSFUNC(Set),
