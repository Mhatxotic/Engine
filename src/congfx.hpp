...
{ /* -- Private variables -------------------------------------------------- */
  ...
  void ConGfxCommitScale()
    { ConGfxGetFontRef().SetSize(fTextScale); }
  /* -- Commit default letter spacing -------------------------------------- */
  void ConGfxCommitLetterSpacing()
    { ConGfxGetFontRef().SetCharSpacing(fTextLetterSpacing); }
  /* -- Commit default line spacing ---------------------------------------- */
  void ConGfxCommitLineSpacing()
    { ConGfxGetFontRef().SetLineSpacing(fTextLineSpacing); }
  ...
  { // Disable and hide console, and restore size
    ...
    ConGfxSetHeight(cCVars->GetInternal<GLfloat>(CON_HEIGHT));
    // Restore console font properties
    ConGfxRestoreDefaultProperties();
  }
  ...
  { // Shift queued console lines
    ...
    ConGfxGetTextureRef().FboItemSetQuadRGBAInt(ulBgColour);
    ...
    ConGfxGetFontRef().FboItemSetQuadRGBAInt(ulFgColour);
