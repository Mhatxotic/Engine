...
{ /* ----------------------------------------------------------------------- */
  ...
  CC_CRASH,     CC_CREDITS, CC_CVARS,     CC_CVCLR,    CC_CVLOAD,
  CC_CVNPK,     CC_CVPEND,  CC_CVSAVE,    CC_DIR,      CC_ENV,
  CC_EVENTS,    CC_FBOS,    CC_FILES,     CC_FIND,     CC_FONTS,
  CC_FTFS,      CC_GPU,     CC_GRESET,    CC_IMAGES,   CC_IMGFMTS,
  CC_INPUT,     CC_JSONS,   CC_LCALC,     CC_LCMDS,    CC_LEND,
  CC_LEXEC,     CC_LFUNCS,  CC_LG,        CC_LGC,      CC_LOG,
  CC_LOGCLR,    CC_LPAUSE,  CC_LRESET,    CC_LRESUME,  CC_LSTACK,
  CC_LVARS,     CC_MASKS,   CC_MEM,       CC_MLIST,    CC_MODS,
  CC_OBJS,      CC_OGLEXT,  CC_OGLFUNC,   CC_PALETTES, CC_PCMFMTS,
  CC_PCMS,      CC_QUIT,    CC_RESTART,   CC_SAMPLES,  CC_SHADERS,
